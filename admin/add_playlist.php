...
<section class="playlist-form">
   ...
   <h1 class="heading">Criar Curso</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Descrição do curso <span>*</span></p>
      ...
      <input type="submit" value="Criar Curso" name="submit" class="btn">
   </form>
