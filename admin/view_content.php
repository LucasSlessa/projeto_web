   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('deletar video?');" name="delete_video">
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty">sem comentarios ainda! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">adicionar videos</a></p>';
   }
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('deletar comentario?');">deletar comentario</button>
         </form>
      </div>
      <?php
       }
      }else{
         echo '<p class="empty">sem comentarios!</p>';
      }
      ?>
      </div>
